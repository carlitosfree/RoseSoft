...
namespace RoseSoft
{
    public partial class proveedorModificar : Form
    {
        ...
        {
            string actualizarCliente = "UPDATE Proveedor set nombresP ='" + textBox2.Text + "' ,paisP ='" + textBox3.Text + "',ciudadP='" + textBox4.Text + "',direccionP='" + textBox5.Text + "', telefonoP = '" + textBox6.Text + "', emailP='" + textBox7.Text + "', cantidadProductoN='" + textBox8.Text + "', cantidadProductoI='" + textBox9.Text + "' where cedulaP = " + textBox1.Text + "";
